      ...
      >
        <Tab.List className="absolute top-0 left-0 flex w-full px-2 pt-2 space-x-2 text-sm text-stone-500/75 prefers-contrast:text-stone-800 dark:text-stone-100">
          <div className="flex items-stretch justify-between w-full space-x-4">
            ...
            <div
              className={`flex space-x-2 rounded-md z-[4] py-1 flex-shrink-0 justify-center px-1 backdrop-filter backdrop-blur-md backdrop-brightness-90 bg-stone-50/75 dark:bg-stone-800/30 motion-safe:transition-opacity sm:shadow-md sm:shadow-stone-400/10 prefers-contrast:shadow-none dark:shadow-stone-900/20 ${touchStyle}`}
            >
