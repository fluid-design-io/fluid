    ...
    <>
      <div className="-mx-4 sm:mx-auto">
        ...
        >
          ...
          <div
            className={clsxm(
              "absolute top-0 left-0 right-0 z-10 mt-2 flex w-full items-stretch justify-between space-x-4 px-4",
              isPrefDark && "dark"
            )}
          >
            <h5
            ...
            <div
              className={`z-[4] flex flex-shrink-0 justify-center space-x-2 rounded-md bg-primary-50/75 py-1 px-1 backdrop-blur-md backdrop-brightness-90 backdrop-filter motion-safe:transition-opacity contrast-more:shadow-none dark:bg-primary-800/30 dark:shadow-primary-900/20 sm:shadow-md sm:shadow-primary-400/10 ${touchStyle}`}
            >
              {preferences.map(
                (
                  {
