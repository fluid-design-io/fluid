...
export const buttonColors = [
  {
    ...
    color: {
      light: `
        ...
        contrast-more:bg-stone-50
        contrast-more:text-stone-900
        contrast-more:border-stone-800
        contrast-more:hover:bg-stone-50
        contrast-more:focus:bg-stone-50
        contrast-more:hover:text-stone-900
        ...
        dark:contrast-more:text-stone-50
        dark:contrast-more:hover:bg-stone-800
        dark:contrast-more:focus:bg-stone-800
        dark:contrast-more:hover:text-stone-50
        dark:contrast-more:focus:text-stone-50
        dark:contrast-more:border-stone-200
      ...
      dark: `
        ...
        contrast-more:border
        contrast-more:border-stone-50
        contrast-more:hover:bg-stone-600
        contrast-more:focus:bg-stone-600
        contrast-more:hover:text-stone-50
        ...
        dark:contrast-more:bg-stone-100
        dark:contrast-more:text-stone-900
        dark:contrast-more:hover:bg-stone-800
        dark:contrast-more:focus:bg-stone-800
        dark:contrast-more:border-stone-500
