...
function Example() {
  return (
    ...
    {/* Light - Small Size */}
      ...
      <button
        className={\`flex-shrink-0 flex justify-center items-center px-2.5 py-1 text-xs font-semibold prefers-contrast:py-1.5 prefers-contrast:px-3 ${
      ...
      <button
        className={\`flex-shrink-0 flex justify-center items-center px-4 py-2 text-sm font-medium prefers-contrast:py-2.5 prefers-contrast:px-4.5 ${
          activeButton.color.light
      ...
      <button
        className={\`flex-shrink-0 flex justify-center items-center px-4 py-2 tracking-wide font-medium prefers-contrast:py-2.5 prefers-contrast:px-4.5 ${
          activeButton.color.light
      ...
      <button
        className={\`flex-shrink-0 flex justify-center items-center px-6 py-2.5 tracking-wider font-semibold prefers-contrast:py-2.5 ${
          activeButton.color.light
