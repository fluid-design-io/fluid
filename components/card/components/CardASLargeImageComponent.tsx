    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between flex-shrink-0 w-full px-4 py-4 space-x-4 bg-stone-50 bg-opacity-30 dark:bg-stone-800 dark:bg-opacity-40 backdrop-filter backdrop-blur-3xl backdrop-saturate-150 backdrop-brightness-105 dark:backdrop-brightness-95 z-[3] prefers-contrast:bg-opacity-80 dark:prefers-contrast:bg-opacity-80 transition">
        ...
        <div className="flex-shrink-0">
          <button
            className="px-3 py-1.5 font-bold rounded-full bg-stone-50 text-sky-600 min-w-[4.5rem] max-w-[5rem] text-ellipsis truncate hover:bg-stone-300 transition select-none text-sm relative z-[5] dark:bg-stone-700 dark:hover:bg-stone-800 dark:text-sky-500/80 prefers-contrast:ring-2 prefers-contrast:ring-sky-700 dark:prefers-contrast:ring-sky-500 prefers-contrast:ring-offset-0 outline-none prefers-contrast:text-sky-700 dark:prefers-contrast:text-sky-400 uppercase focus-within:ring focus-within:ring-sky-500 focus-within:ring-offset border-0"
            onClick={(e) => {
              e.preventDefault();
              setNotification({
                enabled: true,
