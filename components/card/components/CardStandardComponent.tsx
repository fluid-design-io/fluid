...
function CardStandardComponent({ setNotification, src = undefined, ...props }) {
  ...
  return (
    <div
      className={`w-full max-w-xs overflow-hidden transform translate-x-0 shadow component card-bg rounded-xl bg-stone-50 dark:bg-stone-900 dark:prefers-contrast:bg-black ${contrastRing} ${
