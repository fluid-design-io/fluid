    ...
    <div className="max-w-[480px] mx-auto block md:!hidden pt-16">
      <div className="relative rounded-[3rem] shadow-lg shadow-primary-500/10 dark:shadow-primary-900 mx-[14.5%]">
        ...
        <div className="overflow-hidden">
          <div className="inner aspect-[1.125/2.236] rounded-[3rem] border-[0.825rem] border-primary-300 contrast-more:border-primary-600 dark:contrast-more:border-primary-200 dark:border-primary-700 pb-4 relative flex justify-center items-start overflow-hidden dark:bg-primary-700/50 transform">
            {children}
          </div>
        </div>
      </div>
