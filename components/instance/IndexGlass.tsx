...
function IndexGlass() {
  ...
  return (
    <>
        ...
        >
          <div className="w-full h-full">
            ...
            <motion.div className="absolute left-2.5 bottom-2.5 rounded-full w-20 hover:bg-stone-50/30 dark:hover:bg-stone-100/10 transition border-stone-50/50 dark:border-white/5 border flex z-10">
              <div className="border-r rounded-full bg-stone-50/10 dark:bg-stone-500/10 border-stone-50/50 dark:border-white/5">
      ...
      <p className="absolute w-full text-xs text-center bottom-2 text-stone-700/70 dark:text-stone-300">
