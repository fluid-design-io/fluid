...
Based on contrast ratio, each button's foreground color is set to the opposite of the background color. Read more about accessible color contrast <ExternalLink href='https://www.w3.org/TR/WCAG20-TECHS/G18.html'>here</ExternalLink>.
