  ...
  return (
    <Page meta={meta} sidebar={false} className=''>
      ...
      <section className={`prose mx-auto pt-16 dark:prose-invert`}>
        ...
        <p>
          At Fluid Design, accessible from https://fluid-design.io, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Fluid Design and how we use it.
        </p>
        ...
        <p>
          ...
          advertising partners of Fluid Design.
        </p>
        ...
        <p>
          Note that Fluid Design has no access to or control over these cookies
        ...
        <p>
          Fluid Design does not knowingly collect any Personal Identifiable
