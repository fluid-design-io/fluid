...
var ScrollSpy = function (_a) {
    ...
    function () {
      ...
      navContainerRef
        ? setNavContainerItems(
            (_a = navContainerRef.current) === null || _a === void 0
              ? void 0
              : _a.querySelectorAll('[data-' + useDataAttribute + ']')
          )
        : setNavContainerItems(
  ...
  var isVisible = function (el) {
    ...
    if (useBoxMethod) {
      var useHeight = (
        parentScrollContainerRef === null || parentScrollContainerRef === void 0
          ? void 0
          : parentScrollContainerRef.current
      )
        ? parentScrollContainerRef === null ||
          parentScrollContainerRef === void 0
          ? void 0
    ...
    var _loop_1 = function (i) {
      ...
      if (elementIsVisible) {
        ...
        navContainerItems.forEach(function (el) {
          ...
          if (
            attrId === changeHighlightedItemId_1 &&
  ...
  if (typeof window !== 'undefined') {
    parentScrollContainerRef
      ? // if ref for scrollable div is provided
        (_b = parentScrollContainerRef.current) === null || _b === void 0
        ? void 0
        : _b.addEventListener(
            'scroll',
