...
function IndexGlass() {
  ...
  return (
    <>
      ...
      >
        <Tilt
          className='relative w-full h-full overflow-hidden transition border shadow-lg select-none glass-glare rounded-2xl bg-gradient-to-tl from-white/20 to-gray-200/5 border-white/20 dark:border-white/5 dark:from-gray-500/20 dark:to-gray-800/10 backdrop-filter backdrop-blur-xl shadow-sky-800/10 touch-pan-y'
          glareEnable={true}
          glareMaxOpacity={1}
          tiltEnable={false}
        >
              ...
              <HeartIcon
                className={`w-4 h-4 m-1 transition group-active:scale-75 ${
                  isFav
                    ...
                    : `text-gray-50/80 dark:text-gray-700`
                }`}
              />
            </div>
            <motion.div className='absolute left-2.5 bottom-2.5 rounded-full w-20 hover:bg-gray-50/30 dark:hover:bg-gray-100/10 transition border-gray-50/50 dark:border-white/5 border flex z-10'>
              <div className='border-r rounded-full bg-gray-50/10 dark:bg-gray-500/10 border-gray-50/50 dark:border-white/5'>
                <UserIcon className='w-4 h-4 m-1 text-gray-50/80 dark:text-gray-200/30' />
              </div>
            </motion.div>
          </div>
        </Tilt>
      ...
      <p className='absolute w-full text-xs text-center bottom-2 text-gray-700/70 dark:text-gray-300'>
